...
## Overview
This project implements Dijkstra's algorithm in PHP to find the shortest path between nodes in a weighted graph. The algorithm calculates the minimum distance from a starting node to all other nodes in the graph.
